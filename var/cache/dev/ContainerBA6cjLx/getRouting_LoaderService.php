...
class getRouting_LoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor-bundle/src/Routing/RoutingAnnotationLoader.php';
        ...
        $a->addLoader(new \DH\AuditorBundle\Routing\RoutingAnnotationLoader($c, $container->parameters['dh_auditor.provider.doctrine.configuration']));
        $a->addLoader($c);
