...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Auditor.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Configuration.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/User/UserProviderInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor-bundle/src/User/UserProvider.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/security-core/Security.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Security/RoleCheckerInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor-bundle/src/Security/RoleChecker.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Security/SecurityProviderInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor-bundle/src/Security/SecurityProvider.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/ConfigurationInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/Doctrine/Configuration.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/ProviderInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/AbstractProvider.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/Doctrine/DoctrineProvider.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/Service/ServiceInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/Service/AbstractService.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/Doctrine/Service/DoctrineService.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/Service/StorageServiceInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/Doctrine/Service/StorageService.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/Service/AuditingServiceInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor/src/Provider/Doctrine/Service/AuditingService.php';
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor-bundle/src/Event/ViewerEventSubscriber.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/damienharper/auditor-bundle/src/Twig/Extension/TwigExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8C9tombQ64', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vFmRqCMAKC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        ]), [0 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 1 => 'DH\\Auditor\\Provider\\Doctrine\\Persistence\\Event\\CreateSchemaListener']);
    ...
    {
        $a = ($this->privates['DH\\Auditor\\Provider\\Doctrine\\DoctrineProvider'] ?? $this->getDoctrineProviderService());

        if (isset($this->privates['DH\\Auditor\\Auditor'])) {
            return $this->privates['DH\\Auditor\\Auditor'];
        }
        $b = new \DH\Auditor\Configuration($this->parameters['dh_auditor.configuration']);

        $c = new \Symfony\Component\Security\Core\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
        ...
        $b->setUserProvider(new \DH\AuditorBundle\User\UserProvider($c, ($this->privates['DH\\Auditor\\Provider\\Doctrine\\Configuration'] ?? $this->getConfigurationService())));
        $b->setRoleChecker(new \DH\AuditorBundle\Security\RoleChecker($c, $a));
        $b->setSecurityProvider(new \DH\AuditorBundle\Security\SecurityProvider(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->privates['security.firewall.map'] ?? $this->getSecurity_Firewall_MapService())));

        $this->privates['DH\\Auditor\\Auditor'] = $instance = new \DH\Auditor\Auditor($b, ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));

        $instance->registerProvider($a);
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L-HPc1HPOu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iOLv9pqCEo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u-ghufUlZp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OAH9C71BAO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KqZBhA6WpI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.authentication.provider.ldap_bind.main'] ?? $this->load('getSecurity_Authentication_Provider_LdapBind_MainService'));
