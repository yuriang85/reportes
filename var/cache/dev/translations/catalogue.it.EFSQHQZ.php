...
$catalogue = new MessageCatalogue('it', array (
  ...
  'messages' => 
  array (
    'audit.header.home' => 'Home',
    'audit.header.audited_entities' => 'entità attualmente controllate',
    'audit.table_headers.entity' => 'Entità',
    'audit.table_headers.table' => 'Tabella',
    'audit.table_headers.activity' => 'Attività',
    'audit.audit_details.view_audit' => 'Visualizza audit',
    'audit.audit_details.most_recent' => '(la più recente per prima)',
    'audit.audit_details.entry_title' => 'Visualizza tutte le operazioni per una transazione',
    'audit.audit_details.property' => 'Proprietà',
    'audit.audit_details.old_value' => 'Vecchio valore',
    'audit.audit_details.new_value' => 'Nuovo valore',
    'audit.audit_details.transaction' => 'Transazione',
    'audit.audit_details.entity_per_entity' => '(entità per entità)',
    'audit.pager.first' => 'Primo',
    'audit.pager.previous' => 'Precedente',
    'audit.pager.last' => 'Ultimo',
    'audit.pager.next' => 'Prossimo',
    'audit.pager.current' => 'attuale',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    'audit.header.home' => 'Home',
    'audit.header.audited_entities' => 'audited entities',
    'audit.table_headers.entity' => 'Entity',
    'audit.table_headers.table' => 'Table',
    'audit.table_headers.activity' => 'Activity',
    'audit.audit_details.view_audit' => 'View audit',
    'audit.audit_details.most_recent' => '(most recent first)',
    'audit.audit_details.entry_title' => 'View all operations within this transaction',
    'audit.audit_details.property' => 'Property',
    'audit.audit_details.old_value' => 'Old value',
    'audit.audit_details.new_value' => 'New value',
    'audit.audit_details.transaction' => 'Transaction',
    'audit.audit_details.entity_per_entity' => '(entity per entity)',
    'audit.pager.first' => 'First',
    'audit.pager.previous' => 'Previous',
    'audit.pager.last' => 'Last',
    'audit.pager.next' => 'Next',
    'audit.pager.current' => 'Current',
  ),
));
