...
$catalogue = new MessageCatalogue('de', array (
  ...
  'messages' => 
  array (
    'audit.header.home' => 'Startseite',
    'audit.header.audited_entities' => 'geprüfte Objekte',
    'audit.table_headers.entity' => 'Objekt',
    'audit.table_headers.table' => 'Tabelle',
    'audit.table_headers.activity' => 'Aktivität',
    'audit.audit_details.view_audit' => 'Audits anzeigen',
    'audit.audit_details.most_recent' => '(neueste zuerst)',
    'audit.audit_details.entry_title' => 'Alle Operationen dieser Transaktion anzeigen',
    'audit.audit_details.property' => 'Eigenschaft',
    'audit.audit_details.old_value' => 'Alter Wert',
    'audit.audit_details.new_value' => 'Neuer Wert',
    'audit.audit_details.transaction' => 'Transaktion',
    'audit.audit_details.entity_per_entity' => '(Objekt pro Objekt)',
    'audit.pager.first' => 'Erste',
    'audit.pager.previous' => 'Vorherige',
    'audit.pager.last' => 'Letzte',
    'audit.pager.next' => 'Weiter',
    'audit.pager.current' => 'aktuell',
  ),
));
