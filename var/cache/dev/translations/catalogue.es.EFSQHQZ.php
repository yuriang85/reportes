...
$catalogue = new MessageCatalogue('es', array (
  ...
  array (
    ...
    'audit.header.audited_entities' => 'entidades auditadas',
    'audit.table_headers.entity' => 'Entidad',
    'audit.table_headers.table' => 'Tabla',
    'audit.table_headers.activity' => 'Actividad',
    'audit.audit_details.view_audit' => 'Ver audit',
    'audit.audit_details.most_recent' => '(el más reciente primero)',
    'audit.audit_details.entry_title' => 'Ver todas las operaciones dentro de esta transacción',
    'audit.audit_details.property' => 'Propiedad',
    'audit.audit_details.old_value' => 'Viejo valor',
    'audit.audit_details.new_value' => 'Nuevo valor',
    'audit.audit_details.transaction' => 'Transacción',
    'audit.audit_details.entity_per_entity' => '(entidad por entidad)',
    'audit.pager.first' => 'Primero',
    'audit.pager.previous' => 'Anterior',
    'audit.pager.last' => 'Ultimo',
    'audit.pager.next' => 'Siguente',
    'audit.pager.current' => 'Actual',
  ),
));
