...
$catalogue = new MessageCatalogue('et', array (
  ...
  'messages' => 
  array (
    'audit.header.home' => 'Kodu',
    'audit.header.audited_entities' => 'auditeeritud kirjed',
    'audit.table_headers.entity' => 'Kirje',
    'audit.table_headers.table' => 'Tabel',
    'audit.table_headers.activity' => 'Toiming',
    'audit.audit_details.view_audit' => 'Vaata auditit',
    'audit.audit_details.most_recent' => '(hiljuti lisatud eespool)',
    'audit.audit_details.entry_title' => 'Vaatle kõiki selle transaktsiooni toiminguid',
    'audit.audit_details.property' => 'Rekvisiit',
    'audit.audit_details.old_value' => 'Vana väärtus',
    'audit.audit_details.new_value' => 'Uus väärtus',
    'audit.audit_details.transaction' => 'Transaktsioon',
    'audit.audit_details.entity_per_entity' => '(kirje kaupa)',
    'audit.pager.first' => 'Esimene',
    'audit.pager.previous' => 'Eelmine',
    'audit.pager.last' => 'Viimane',
    'audit.pager.next' => 'Järgmine',
    'audit.pager.current' => 'Praegune',
  ),
));
