...
return [
    ...
    'dh_auditor_list_audits' => [[], ['_controller' => 'DH\\AuditorBundle\\Controller\\ViewerController::listAuditsAction'], [], [['text', '/audit']], [], []],
    'dh_auditor_show_transaction' => [['hash'], ['_controller' => 'DH\\AuditorBundle\\Controller\\ViewerController::showTransactionAction'], [], [['variable', '/', '[^/]++', 'hash', true], ['text', '/audit/transaction']], [], []],
    'dh_auditor_show_entity_history' => [['entity', 'id'], ['id' => null, '_controller' => 'DH\\AuditorBundle\\Controller\\ViewerController::showEntityHistoryAction'], [], [['variable', '/', '[^/]++', 'id', true], ['variable', '/', '[^/]++', 'entity', true], ['text', '/audit']], [], []],
